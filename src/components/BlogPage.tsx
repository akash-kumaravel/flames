    ...
    <div id="blog-catalog-page" className="pt-28 pb-20 px-6 md:px-12 bg-[#FAF9F6]">
      <div className="max-w-7xl mx-auto">
        ...
        {!selectedArticleId ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {BLOG_ARTICLES.map((article) => (
                <div
                  key={article.id}
                  className="bg-white rounded-3xl overflow-hidden border border-neutral-200/50 shadow-xs hover:shadow-lg transition-all duration-300 flex flex-col justify-between"
                >
                  <div className="p-8">
                    {/* Meta stats */}
                    <div className="flex items-center gap-3 text-[10px] uppercase font-mono font-bold text-neutral-400 mb-4 pb-3 border-b border-neutral-100">
                    ...
                    <p className="font-sans text-xs text-neutral-450 italic mb-4">
                      Target Search Focus: &ldquo;{article.targetKeyword}&rdquo;
                    </p>

                    <p className="font-sans text-sm text-neutral-500 leading-relaxed line-clamp-4">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-14 border border-neutral-200/50 shadow-xs">
            ...
            <div className="mb-10 pb-6 border-b border-neutral-200">
              ...
              <h1 className="font-sans font-semibold text-2xl md:text-4xl text-neutral-900 tracking-tight mt-4 leading-tight">
                {activeArticle?.title}
              </h1>

              <div className="flex flex-wrap gap-4 items-center mt-6 text-xs font-mono font-semibold text-neutral-400">
                <span className="flex items-center gap-1">
            ...
            <div className="prose max-w-none text-neutral-600 font-sans text-base leading-relaxed space-y-8">
              <p className="font-medium text-neutral-800 text-lg leading-relaxed">
                {activeArticle?.content.intro}
              </p>

              {activeArticle?.content.sections.map((section, sidx) => (
                <div key={sidx} className="space-y-4 pt-4">
                  <h3 className="font-sans font-semibold text-lg md:text-xl text-neutral-900 tracking-tight flex items-center gap-2">
            ...
            <div className="mt-12 pt-8 border-t border-neutral-100 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                <h4 className="font-sans font-semibold text-neutral-900 text-sm">
              ...
              <button
                ...
                className="px-5 py-3 rounded-full bg-neutral-900 text-white hover:bg-orange-500 transition-colors duration-300 font-sans text-xs font-semibold cursor-pointer whitespace-nowrap"
              >
